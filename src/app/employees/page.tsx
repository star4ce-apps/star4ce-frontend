...
export default function EmployeesPage() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      // If no role is set, default to 'admin' for development (since auth is bypassed)
      if (storedRole) {
        setRole(storedRole);
      } else {
        setRole('admin'); // Default for development
      }
      // Always load employees since auth is bypassed
      loadEmployees();
    }
  }, []);
